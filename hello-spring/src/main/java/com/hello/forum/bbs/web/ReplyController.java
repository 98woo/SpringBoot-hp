...
@RestController // 모든 응답이 JSON 으로 전달된다. Controller 와 ResponseBody 를 상속 받았기 때문에
public class ReplyController {
	...
	public AjaxResponse doRecommendReplies(@PathVariable int replyId, @SessionAttribute("_LOGIN_USER_") MemberVO memberVO) {
		boolean isSuccess = this.replyService.recommendOneReply(replyId, memberVO.getEmail());
